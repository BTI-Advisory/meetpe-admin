...
class RappelExperienceNotification extends Notification implements ShouldQueue
{
    use Queueable;
    ...
    {
                        App::setLocale($this->locale); // ← C'est maintenant ici que tu set la langue

        $notification = ['title' => 'Meet People', 'text' => __('general.rappel_voyageur_title', ['guide' => $this->guideName]), 'sound' => 'default', 'badge' => '1'];

        return (new FcmMessage(
            notification: new FcmNotification(
                title: 'Meet People',
                body: __('general.rappel_voyageur_title', ['guide' => $this->guideName]),
    ...
    public function toMail(object $notifiable): MailMessage
    {
        ...
        return (new MailMessage())
            ...
            ->subject(__('general.rappel_voyageur_title', ['guide' => $this->guideName]))
            ->view('notifications.reservation.'.$this->locale.'_rappelexperience', [
