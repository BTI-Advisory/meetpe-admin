...
class MessageDeBienvenueFondatteur extends Notification
{
    use Queueable;
    ...
    {
        $notification = array('title' => __('general.welcome'), 'text' => __('general.welcome_text'), 'sound' => 'default', 'badge' => '1');

        return (
            new FcmMessage(
                notification: new FcmNotification(
                    title: __('general.welcome'),
                    body: __('general.welcome_text'),
    ...
    public function toMail(object $notifiable): MailMessage
    {
        ...
        return (new MailMessage)
            ...
            ->subject(__('general.welcome_text'))

            ->view(
                'notifications.welcome.'.App::getLocale().'_welcome',
                ["username" => explode("@", $notifiable->email)[0], "currentYear" => $now->year]
            );
    }
