...
class SuppressionExperienceNotification  extends Notification
{
    use Queueable;
    ...
    {
        $notification = array('title' => "Meet People", 'text' => __('general.delete_experience_title', ['experience' => $this->name]), 'sound' => 'default', 'badge' => '1');

        return (
            new FcmMessage(
                notification: new FcmNotification(
                    title: "Meet People",
                    body: __('general.delete_experience_title', ['experience' => $this->name]),
    ...
    public function toMail(object $notifiable): MailMessage
    {
        ...
        return (new MailMessage)
            ...
            ->subject(__('general.delete_experience_title', ['experience' => $this->name]))

            ->view(
                'notifications.experience.'.App::getLocale().'_deleteexperience',
                ["username" => explode("@", $notifiable->email)[0], "currentYear" => $now->year, "experienceName"=>$this->name]
            );
    }
