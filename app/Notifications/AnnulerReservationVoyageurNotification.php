...
class AnnulerReservationVoyageurNotification extends Notification
{
    use Queueable;
    ...
    {
        $notification = ['title' => 'Meet People', 'text' => __('general.booking_cancelled', ['experience' => $this->experienceName]), 'sound' => 'default', 'badge' => '1'];

        return (new FcmMessage(
            notification: new FcmNotification(
                title: 'Meet People',
                body: __('general.booking_cancelled', ['experience' => $this->experienceName]),
    ...
    public function toMail(object $notifiable): MailMessage
    {
        ...
        return (new MailMessage())
            ...
            ->subject(__('general.booking_cancelled', ['experience' => $this->experienceName]))
            ->view('notifications.reservation.'.App::getLocale().'_annulerreservationvoyageur', [
