...
class DemandeDassistance extends Notification
{
    use Queueable;
    ...
    {
        $notification = array('title' => "Meet People", 'text' => __('general.contact_us_title'), 'sound' => 'default', 'badge' => '1');

        return (
            new FcmMessage(
                notification: new FcmNotification(
                    title: "Meet People",
                    body: __('general.contact_us_title'),
    ...
    public function toMail(object $notifiable): MailMessage
    {
        ...
        return (new MailMessage)
            ...
            ->subject(__('general.contact_us_title'))
            ->view(
                'notifications.assistance.'.App::getLocale().'_Demande_daassistance',
