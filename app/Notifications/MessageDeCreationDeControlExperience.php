...
class MessageDeCreationDeControlExperience extends Notification
{
    use Queueable;
    ...
    {
        $notification = array('title' => "Meet People", 'text' => __('general.experience_created'), 'sound' => 'default', 'badge' => '1');

        return (
            new FcmMessage(
                notification: new FcmNotification(
                    title: "Meet People",
                    body: __('general.experience_created'),
    ...
    public function toMail(object $notifiable): MailMessage
    {
        ...
        return (new MailMessage)
            ...
            ->subject(__('general.experience_created'))
            ->view(
                'notifications.profile.'.App::getLocale().'_creationExpereince',
                ["username" => $notifiable->name, "currentYear" => $now->year, "experienceTitle"=>$this->experienceTitle]
            );
    }
