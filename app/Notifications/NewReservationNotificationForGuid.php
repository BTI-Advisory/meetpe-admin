...
class NewReservationNotificationForGuid  extends Notification
{
    use Queueable;
    //private string $name ;
    ...
    {
        $notification = array('title' => "Meet People", 'text' => __('general.new_booking_title', ['experience' => $this->name]), 'sound' => 'default', 'badge' => '1');

        return (
            new FcmMessage(
                notification: new FcmNotification(
                    title: "Meet People",
                    body: __('general.new_booking_title', ['experience' => $this->name]),
    ...
    public function toMail(object $notifiable): MailMessage
    {
        ...
        return (new MailMessage)
            ...
            ->subject(__('general.new_booking_title', ['experience' => $this->name]))
            ->view(
                'notifications.reservation.'.App::getLocale().'_NewReservationForGuid',
