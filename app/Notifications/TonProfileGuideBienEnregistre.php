...
class TonProfileGuideBienEnregistre extends Notification
{
    use Queueable;
    ...
    {
        $notification = array('title' => "Meet People", 'text' => __('general.guide_profil_created'), 'sound' => 'default', 'badge' => '1');

        return (
            new FcmMessage(
                notification: new FcmNotification(
                    title: "Meet People",
                    body:  __('general.guide_profil_created'),
    ...
    public function toMail(object $notifiable): MailMessage
    {
        ...
        return (new MailMessage)
            ...
            ->subject(__('general.guide_profil_saved'))

            ->view(
                'notifications.profile.'.App::getLocale().'_profileBienEnregistre',
