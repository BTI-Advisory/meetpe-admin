...
<title>Votre expérience est à compléter</title>
...
<td class="content">
    ...
    <p>Nous avons examiné votre expérience <strong>{{ $experienceName }}</strong> et elle nécessite des modifications avant de pouvoir être mise en ligne.</p>

    <p><strong>Raison(s) :</strong></p>
    ...
    <p>Merci de vous connecter à l'application Meet People pour apporter les modifications demandées et soumettre à nouveau votre expérience.</p>

    <p>Si vous avez des questions ou besoin d'aide, contactez-nous à : <a href="mailto:contact@meetpe.fr">contact@meetpe.fr</a> 🧡</p>
